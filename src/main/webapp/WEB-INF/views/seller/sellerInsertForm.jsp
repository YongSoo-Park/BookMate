                                ...
                                <div class="row d-flex justify-content-center align-items-center">
                                    <div class="col-md-12 regForm">
                                        ...
                                        <div class="tab" style="padding: inherit;">
                                            <h1 id="register" style="text-align: center;">책구메이트 중고장터 판매자 이용약관 동의</h1>
                                            <br><br>
                                            <div class="form-group">
                                                <label class="container-checkbox">
                                                    책구메이트 중고장터 이용약관을 모두 읽었으며 이에 동의합니다.
...
제1조(목적) 이 약관은 책구메이트(전자상거래 사업자)가 운영하는 중고장터(이하 "중고장터"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 중고장터 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.

  ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」

제2조(정의)

  ① "중고장터"이란 중고장터가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.

  ② “이용자”란 "중고장터"에 접속하여 이 약관에 따라 "책장메이트"이 제공하는 서비스를 받는 회원 및 비회원을 말합니다.

  ③ ‘회원’이라 함은 "책구메이트"에 회원등록을 한 자로서, 계속적으로 "책구메이트"이 제공하는 서비스를 이용할 수 있는 자를 말합니다.

  ④ ‘비회원’이라 함은 회원에 가입하지 않고 "책구메이트"이 제공하는 서비스를 이용하는 자를 말합니다.
...
제24조(재판권 및 준거법)
  ...
  ② "책장메이트"과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
                                            ...
                                            <textarea style="resize: none; height: 300px;" class="txtarea" readonly="readonly">
책구메이트(이하 '책구메이트')은(는) 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
...
책구메이트('http://localhost:8090/spring/ubookMain.ub'이하 '책구메이트')은(는) 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
